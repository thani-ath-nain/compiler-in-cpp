...
class parser
{
    ...
    void main_fun();
    void statments();
    void dec_ini_assi(string& value, string& type, string& id_v, bool& flag);
    void declaration();
    void ini_assi_statment(string& value, string& type, string& id_v);
    void initialization();
    void input(string &id_v);
    void output(string& id_v, bool& flag);
    void output_1(string& id_v, bool& flag);
    void loop();
    void selection();
    void elif_selection(string& re_e, string s_next);
    void else_selection(string &re_e,string s_next);
    void return_statment(string& id_v);
    void assignment_expression(string& id_v);
